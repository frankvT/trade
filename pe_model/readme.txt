...
components of Domestic and World welfare. In particuloar it illustrates the idea of an 'optinmal tariff' that
maximizes overall domestic welfare when the terms of trade effctes of 'large' country model are taken into account.
...
Run:
a) within your faviourite IDE or VS Code
b) from shell command line: pythyon pe_model.py 
					or:
							python runmodel.py

The script runmodel.py is a good starting point to develop simulations with the model. 
It shows how to cauculate the 'optimal tariff' and creates a number of plots and text outputs.
